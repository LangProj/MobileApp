...
const USER_LEVEL = 'A2'
const TOPIC = 'Conjunctions Articles'
const ALL_SENTENCES = [
  {
    ...
    <View style={{flex: 1}}>
      <View style={[{backgroundColor:'#00B9D2',height:110,width:'100%',justifyContent:'space-around',zIndex:999}]}>
        <View style={[{marginTop:20,flexDirection:'row',width:'100%',justifyContent:'space-around'}]}>
          ...
          <Text style={[{fontSize:28,color:'white',fontWeight:'bold',textAlign:'center',marginTop:20}]}>{USER_LEVEL}</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.mainWrapper}>   
          ...
          <LinearGradient
            ...
            <View style={[{flex:1,alignItems:'center',justifyContent:'center'}]}>          
              <Text style={styles.cardTransciption}>{translatedCardDesc}</Text>
            </View>
          ...
          onRequestClose={() => {
            ...
            <View style={styles.centeredView}>
              ...
              <View style={[styles.modalView]}>
                ...
                <Text style={{fontSize:18, fontWeight:500,color:'gray', width:250, textAlign:'center'}}>{cardDesc}</Text>
              </View>
              <Next/>
            </View>
        ...
        <View style={{flex:1,flexDirection:'row',justifyContent:'space-around',marginTop:10,}}>
          ...
          <TouchableOpacity style={{height:50,backgroundColor:'gray',width:50, borderBottomColor:'#65A3FF', borderBottomWidth:3,}} onPress={() => navigation.navigate('ListScreen')}>
